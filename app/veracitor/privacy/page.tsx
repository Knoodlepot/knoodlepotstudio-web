  ...
  return (
    <PrivacyPage appName="Veracitor" lastUpdated="16 April 2026">
      <Section title="1. Who We Are">
        <p>Veracitor is developed and operated by Knoodlepot Studio, a sole trader based in the United Kingdom. Contact: <a href="mailto:knoodlepot@knoodlepotstudio.com" style={styles.link}>knoodlepot@knoodlepotstudio.com</a></p>
      </Section>
