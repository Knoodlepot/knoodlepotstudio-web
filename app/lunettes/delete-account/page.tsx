...
export const metadata = { title: "Delete Your Account — Lunettes" };

export default function LunettesDeleteAccount() {
  return (
    <DeleteAccountPage appName="Lunettes">
      ...
      <Section title="What gets deleted">
        ...
        <ul style={styles.list}>
          ...
          <li>Your reading history and saved position</li>
          <li>Your voice preferences and reading speed settings</li>
          <li>Any documents you have imported into the app</li>
          <li>Any Family Helper connections associated with your account</li>
