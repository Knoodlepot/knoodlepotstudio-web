...
export const metadata = { title: "Privacy Policy — Lunarium" };

export default function LunariumPrivacy() {
  return (
    <PrivacyPage appName="Lunarium" lastUpdated="16 May 2026">
      <Section title="1. Who We Are">
        <p>Lunarium is developed and operated by Knoodlepot Studio, a sole trader based in the United Kingdom. Contact: <a href="mailto:knoodlepot@knoodlepotstudio.com" style={styles.link}>knoodlepot@knoodlepotstudio.com</a></p>
      </Section>

      <Section title="2. What Data We Collect">
        <p>Lunarium is a self-contained reference app. All moon phase calculations are performed on-device and require no network connection. The app does not require an account and does not collect personal information. The only data stored is:</p>
        <ul style={styles.list}>
          <li><strong>Local app preferences</strong> — your settings and display preferences are saved locally on your device. This data never leaves your device.</li>
      ...
      <Section title="6. Your Rights (UK GDPR)">
        <p>Because Lunarium collects no personal information beyond anonymous purchase identifiers managed by third parties, there is limited personal data for Knoodlepot Studio to action. However, as a UK resident you have the right to:</p>
        <ul style={styles.list}>
