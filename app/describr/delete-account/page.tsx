...
export const metadata = { title: "Delete Your Account — Describr" };

export default function DescriberDeleteAccount() {
  return (
    <DeleteAccountPage appName="Describr">
      ...
      <Section title="What gets deleted">
        ...
        <p>Describr does not store photographs or OCR output after processing — images sent for AI description are discarded immediately after the response is returned. There is no history or saved content to delete beyond your account credentials.</p>
