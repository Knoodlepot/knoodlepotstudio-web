...
export const metadata = { title: "Delete Your Account — Plain English, Please" };

export default function PlainEnglishDeleteAccount() {
  return (
    <DeleteAccountPage appName="Plain English, Please">
      ...
      <Section title="What gets deleted">
        ...
        <p>Plain English, Please does not store the text you submit for translation after processing is complete. There is no saved history beyond your account credentials.</p>
