...
export const metadata = { title: "Delete Your Account — Floriography" };

export default function FloriographyDeleteAccount() {
  return (
    <DeleteAccountPage appName="Floriography">
      ...
      <Section title="What gets deleted">
        ...
        <ul style={styles.list}>
          ...
          <li>Your garden journal and all saved flower entries</li>
          <li>Flower photographs you have uploaded</li>
          <li>Your location history and Garden Map stamp collection</li>
